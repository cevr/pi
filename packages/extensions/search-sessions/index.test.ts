...
import { createSearchSessionsExtension, CONFIG_DEFAULTS, CUSTOM_TYPE, DEFAULT_EXTENSION_DEPS } from "./index";
import { createSearchSessionsExtension, CONFIG_DEFAULTS, SEARCH_SESSIONS_CONFIG_SCHEMA } from "./index";
